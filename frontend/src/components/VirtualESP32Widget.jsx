...
export default function VirtualESP32Widget({
  ...
  return (
    <div className="bg-white border border-slate-200/90 rounded-2xl p-4.5 mb-6 shadow-sm relative animate-fade-in">
        ...
        <div className="flex items-center space-x-2.5">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-400">
              OLED SSD1306 + MQTT Hardware Simulation · Swarm UAV Radar
            </p>
          </div>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
        ...
        {/* OLED Screen */}
        <div className="md:col-span-2 oled-screen rounded-xl p-4 font-mono shadow-inner min-h-[135px] flex flex-col justify-between relative overflow-hidden">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <div className="flex flex-col items-center space-y-1">
            ...
            >
              ...
              <span className="font-mono tracking-widest text-base">S</span>
            </button>
